<?php
function fr_reseller_contact_en_shortcode() {
    ob_start(); 
    global $wpdb;
    ...
    ?>
    <form action="/agritech/index.php/fale-conosco/#wpcf7-f1648-p775-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
