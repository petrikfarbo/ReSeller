                        ...
                        <div class="column_attr mfn-inline-editor clearfix">
                            ...
                            <div>
                                ...
                                <div class="fr-info">
                                    ...
                                    <strong><span class="fr-data-email">E-mail: </span></strong><a class="fr-data-email-info" href="<?= get_site_url().'/contact?data='.base64_encode($reseller['email'])?>"><?=$reseller['email']?></a>
                                </div>
                            </div>
                        </div>
                    </div>
