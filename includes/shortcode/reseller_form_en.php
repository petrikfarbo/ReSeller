        ...
        jQuery(document).ready(function($) {
            ...
            function fillClosestCompanies(localidades) {
                ...
                localidades.forEach(function(localidade) {
                    ...
                    var email2 = localidade.email2 ? '<strong><span class="fr-data-email">E-mail: </span></strong><a href="<?= get_site_url();?>/index.php/contact-us?data=' + btoa(localidade.email2) + '" class="fr-data-email-info">' + localidade.email2 + '</a><br />' : '';
                    ...
                    var html = '<div class="wrap mcb-wrap mcb-wrap-fr one-second tablet-one-second laptop-one-second mobile-one clearfix" data-desktop-col="one-second" data-laptop-col="laptop-one-second" data-tablet-col="tablet-one-second" data-mobile-col="mobile-one">' +
                        ...
                        whatsapp +
                        fax +
                        '<strong><span class="fr-data-email">E-mail: </span></strong><a class="fr-data-email-info" href="<?= get_site_url();?>/index.php/contact-us?data=' + btoa(localidade.email) + '">' + localidade.email + '</a>'+
