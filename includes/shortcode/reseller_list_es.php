<?php
function fr_reseller_list_en_shortcode(){
    ob_start(); 
    ?>
                    ...
                    <div class="column mcb-column mcb-item-q1stusf46 one laptop-one tablet-one mobile-one column_column" style="">
                        <div class="mcb-column-inner mfn-module-wrapper mcb-column-inner-q1stusf46 mcb-item-column-inner">
                            <div class="column_attr mfn-inline-editor clearfix" style="">
                                <p>
                                    <strong>
                                        Tractores<img class="alignnone wp-image-1263" src="<?=plugins_url('/', __FILE__).'img/trator.svg';?>" alt="" width="30" height="30" />&nbsp; &nbsp;|&nbsp; &nbsp; Implementos
                    ...
                    <div class="mcb-column-inner mfn-module-wrapper mcb-column-inner-2mmhkb26m mcb-item-column-inner">
                        <div class="column_attr mfn-inline-editor clearfix">
                            ...
                            <div>
                                ...
                                <div class="fr-info">
                                    <strong><span class="fr-data-address">Dirección: </span></strong><span class="fr-data-address-info"><?=$reseller['address']?><?=(isset($reseller['numero']) && !empty($reseller['numero'])) ? ', '.$reseller['numero'] : '' ;?></span><br />
                                    <strong><span class="fr-data-zipcode">CP: </span></strong><span class="fr-data-zipcode-info"><?=$reseller['zipcode']?></span><br />
                                    <strong><span class="fr-data-phone">Teléfono: </span></strong><span class="fr-data-phone-info"><?=$reseller['phone']?></span><br />
                                    <?= (isset($reseller['phone2']) && !empty($reseller['phone2'])) ? '<strong><span class="fr-data-phone">Teléfono: </span></strong><span class="fr-data-phone-info">' . $reseller['phone2'] . '</span><br />' : '' ; ?>
