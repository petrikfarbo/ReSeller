<?php
function fr_reseller_contact_pt_shortcode() {
    ob_start(); 
    global $wpdb;
    $table_name = $wpdb->prefix . 'reseller_data';

    $reseller_email = isset($_GET['data']) ? base64_decode($_GET['data']) : 'petrikfarbo@mailnesia.com'; //alterar email default para envio caso ñ tenha representante na região
    ...
    if (count($email) > 0) {
        ...
        echo '<input type="email" style="display:none" class="reseller-email-contact" value="petrikfarbo@mailnesia.com">';
    }
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            if($('.reseller-email-contact').val() != 'petrikfarbo@mailnesia.com'){
                $('.reseller-mail input').val($('.reseller-email-contact').val());
            }
            ...
            $('#city').on('change', function() {
                ...
                $('.reseller-mail input').val('petrikfarbo@mailnesia.com');
                $('.mail p').show();
                $('.phone-2').show();
                ...
                $('.mail p').html('<a href="#">petrikfarbo@mailnesia.com</a>');
                localidades.stores.forEach(function(localidade) {
            ...
            $('.wpcf7-form').submit((event) => {
                ...
                localidades.stores.forEach(function(localidade) {
                    if (fr_reseller_email == localidade.email || fr_reseller_email == localidade.email2 || fr_reseller_email == "petrikfarbo@mailnesia.com") {
