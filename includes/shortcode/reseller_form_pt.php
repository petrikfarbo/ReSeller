<?php
function fr_reseller_form_pt_shortcode() {
    ob_start(); 
    global $wpdb;
        ...
        jQuery(document).ready(function($) {
            ...
            function fillClosestCompanies(localidades) {
                ...
                localidades.forEach(function(localidade) {
                    ...
                    var phone2 = localidade.phone2 ? '<strong><span class="fr-data-phone">Tel: </span></strong><span class="fr-data-phone-info">' + localidade.phone2 + '</span><br />' : '';
                    ...
                    var email2 = localidade.email2 ? '<strong><span class="fr-data-email">E-mail: </span></strong><a href="<?= get_site_url();?>/index.php/fale-conosco?data=' + btoa(localidade.email2) + '" class="fr-data-email-info">' + localidade.email2 + '</a><br />' : '';
                    ...
                    var html = '<div class="wrap mcb-wrap mcb-wrap-fr one-second tablet-one-second laptop-one-second mobile-one clearfix" data-desktop-col="one-second" data-laptop-col="laptop-one-second" data-tablet-col="tablet-one-second" data-mobile-col="mobile-one">' +
                        ...
                        '<div class="fr-info">' +
                        '<strong><span class="fr-data-address">Endereço: </span></strong><span class="fr-data-address-info">' + enderecoCompleto + '</span><br />' +
                        '<strong><span class="fr-data-zipcode">CEP: </span></strong><span class="fr-data-zipcode-info">' + cep + '</span><br />' +
                        '<strong><span class="fr-data-phone">Tel: </span></strong><span class="fr-data-phone-info">' + localidade.phone + '</span><br />' +
                        phone2 +
                        whatsapp +
                        fax +
                        '<strong><span class="fr-data-email">E-mail: </span></strong><a class="fr-data-email-info" href="<?= get_site_url();?>/index.php/fale-conosco?data=' + btoa(localidade.email) + '">' + localidade.email + '</a>'+
    ...
    <div class="flex fr-form flex-item-center">
        <form class="w-100">
            <div class="flex fr-zipcode flex-column flex-column">
                <h3 for="zipcode">Digite seu CEP: </h3>
            ...
            <div class="flex fr-filter flex-column">
                <h3>Ou localize pelo estado ou pais de sua escolha:</h3>
